"""
Keepa Deals Endpoint + Amazon Creators API ÃÂ¢ÃÂÃÂ Deal Scraper
----------------------------------------------------------
...
def get_keepa_deals(api_key, cached_asins):
    ...
    for item in all_deals:
        ...
        # Min price $10 ÃÂ¢ÃÂÃÂ current is a list, index varies by price type
...
def main():
    print("=" * 55)
    print("  Keepa Deals + Amazon Creators API ÃÂ¢ÃÂÃÂ DealDrop")
    print("=" * 55)
